    ...
    <div class="main-container">
      ...
      <div class="spotify-playlists">
        ...
        <div class="list">
          ...
          <div class="item">
            <img src="foto/2.jpeg" alt="Rizky Febian">
            <div class="play">
              <span class="fa fa-play"></span>
            </div>
            <h4>RapCaviar</h4>
          ...
          <div class="item">
            <img src="foto/3.jpeg" alt="Rizky Febian">
            <div class="play">
              <span class="fa fa-play"></span>
            </div>
            <h4>All out 2010s</h4>
          ...
          <div class="item">
            <img src="foto/4.jpeg" alt="Rizky Febian">
            <div class="play">
              <span class="fa fa-play"></span>
            </div>
            <h4>Rock Classics</h4>
          ...
          <div class="item">
            <img src="foto/5.jpeg" alt="Rizky Febian">
            <div class="play">
              <span class="fa fa-play"></span>
            </div>
            <h4>Chill Hits</h4>
          ...
          <div class="item">
            <img src="foto/6.jpeg" alt="Rizky Febian">
            <div class="play">
              <span class="fa fa-play"></span>
            </div>
            <h4>Viva Latino</h4>
          ...
          <div class="item">
            <img src="foto/7.jpeg" alt="Rizky Febian">
            <div class="play">
              <span class="fa fa-play"></span>
            </div>
            <h4>Mega Hit Mix</h4>
          ...
          <div class="item">
            <img src="foto/8.jpeg" alt="Rizky Febian">
            <div class="play">
              <span class="fa fa-play"></span>
            </div>
            <h4>All out 80s</h4>
      ...
      <div class="preview">
        ...
        <div class="button">
          <button type="button" onclick="location.href='register.php';">Sign up free</button>
        </div>
      </div>
    </div>
